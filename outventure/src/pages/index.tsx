      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#a16207] to-[#15162c]">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          <h1 className="text-5xl font-extrabold tracking-tight text-white sm:text-[5rem]">
            Out<span className="text-[hsl(200,100%,70%)]">Ven</span>ture
          </h1>
          <p className="text-2xl text-center text-white"> Follow your inner outventurer </p>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8">
            ...
            >
              ...
              <div className="text-lg">
                The ooutdoors is calling. Let your inner adventurer out. Explore new places and create new memories.
              </div>
            </Link>
            <Link
              className="flex max-w-xs flex-col gap-4 rounded-xl bg-white/10 p-4 text-white hover:bg-white/20"
